package com.problem_solving.BFS.Rotting_Oranges;
...
//        0 1 1
    ...
    public static int orangesRotting(int[][] grid) {
        ...
        int m = grid.length, n = grid[0].length; // 3, 3
        int freshCount = 0;
        ...
        if (freshCount == 0) return 0; // No fresh oranges, nothing to do
        ...
        while (!rottenQueue.isEmpty()) {
            ...
            for (int i = 0; i < size; i++) {
                int[] rotten = rottenQueue.poll(); // 0,1
